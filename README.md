...
### 📂 6. 내 파일 필터 및 일괄 선택 삭제 (Bulk Select & Delete)
- **필터 모드**: 구글 로그인 시 상단에 "내가 올린 미디어" 탭이 노출되어 본인의 이미지만 선별 조회할 수 있습니다.
- **다중 선택**: 미디어 카드 좌측 상단의 체크박스를 클릭하거나 "전체 선택" 버튼을 통해 필터링된 모든 미디어를 한 번에 지정 가능합니다.
- **일괄 삭제**:
  - 일반 로그인 사용자는 선택한 파일 중 본인 소유의 미디어만 일괄 삭제가 반영됩니다.
  - 관리자 계정(`mosebb@gmail.com`)은 타인이 업로드한 미디어를 포함해 선택된 모든 미디어를 강제 일괄 삭제 처리할 수 있습니다.
